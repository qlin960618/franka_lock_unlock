...
class FrankaLockUnlock:
    ...
    def _cleanup(self):
        ...
        if self._logged_in:
            self._logout()
        self.print("Successfully cleaned up.")
    ...
    def _logout(self):
        ...
        self._logged_in = False
        self.print("Successfully logged out.")
    ...
    def _request_token(self, physically=False):
        self.print("Requesting a control token...")
        ...
        self.print(f'Received control token is {self._token} with id {self._token_id}.')
    ...
    def _release_token(self):
        ...
        self._token = None
        self._token_id = None
        self.print("Successfully released control token.")
    ...
    try:
        ...
        def print_stdout(*args_):  #override print function
            if len(args_) == 1:
                ...
                node_.get_logger().info(str(args_))
